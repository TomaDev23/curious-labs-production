...
- Authority: `_FRAMING_LOCKED.md` > `COPY_DECK_v2.md` > `CuriousLabs_Consultation_Cinematic_Build_Plan_v1.0.md` > `DRAMA_LAYER.md` > `TASKS.md` > reference images (composition only).
