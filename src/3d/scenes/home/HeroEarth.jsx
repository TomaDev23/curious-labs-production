/**
 * @component HeroEarth
 * @description Hero Earth scene for unified 3D engine - Canvas-free R3F component
 ...
 * 
 * @usage
 * Used within unified 3D engine Canvas context, not standalone
 */
...
// Main HeroEarth component - designed for unified 3D engine
const HeroEarth = ({ 
  scaleFactor = 1, 
  rotationY = 0,
  className = ""
