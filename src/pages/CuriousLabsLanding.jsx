...
const MoonSignalRevealSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-[linear-gradient(135deg,#071016_0%,#11261d_38%,#eef1e6_39%,#f8f4e8_100%)]">
        ...
        <div className="absolute inset-0 bg-[#313231]" style={coverMask}>
          <div className="absolute left-6 top-6 flex items-center gap-3 sm:left-10 sm:top-10">
            <img
              ...
              loading="lazy"
            />
            <span className="font-space text-2xl font-medium text-[#d8d3bc] sm:text-4xl">Moon Signal</span>
          </div>

          <div className="absolute left-6 top-[28%] sm:left-10 lg:left-14">
            <div
              aria-hidden="true"
              className="max-w-[11ch] font-space text-6xl font-semibold leading-none tracking-normal text-[#d8d3bc] sm:text-8xl lg:text-[9rem]"
            >
              Coming Soon
            </div>
            <p className="mt-7 max-w-md font-space text-sm leading-relaxed text-[#d8d3bc]/70 sm:text-base">
